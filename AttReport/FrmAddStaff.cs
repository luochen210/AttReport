    ...
    public partial class FrmAddStaff : Form
    {
        ...
        private void btnSaveStaff_Click(object sender, EventArgs e)
        {
            ...
            Staff objStaff = new Staff()
            {
                ...
                Seniority = Convert.ToDouble(this.txtAge.Text.Trim()),
                Marriage = this.cboMarriage.Text.Trim(),
                Education = this.cboEducation.Text.Trim(),
                Major = txtMajor.Text.Trim(),
                NativePlace = txtNativePlace.Text.Trim(),
                EntryDate = Convert.ToDateTime(dtpEntryDate.Text.Trim()),
                BirthDate = Convert.ToDateTime(dtpBirthDate.Text.Trim()),
                Domicile = txtDomicile.Text.Trim(),
                Residence = txtRelation.Text.Trim(),
                Introducer = txtIntroducer.Text.Trim(),
                Friend = txtFriend.Text.Trim(),
                Relation = txtRelation.Text.Trim(),
                FriendsPhone = txtFriendPhone.Text.Trim(),
            };
